...
<div id="wrap">
    <header>
  <h1>회원정보를 클릭하면 회원에게 해야할 운동과 식단을 보낼수 있습니다</h1>
	</header>
        		 ...
        		 <tr class="cart-deal-item " data-item-status="CHECKED" data-adult="false" data-bundle-id="4794036806" data-bundle-type="PRODUCT" data-app="" data-group-type="rocket">
                    ...
                    <td class="product-box">
                        <div class="product-name-part">
                            <a href="<%=request.getContextPath() %>/HW/mypageuser/memberNotice.do?memId=<%=memberList.get(i).getMemId() %>" class="product-name moveProduct modify-color">
                            	<% 

   ...
   <div class="container">
      ...
      <div class="menu-menu-1-container" onchange="dis()">
        <ul id="menu-menu-1" class="menu">
				...
				<li>
				<a href="<%=request.getContextPath() %>/HW/exerboard/list.do" class="aa">게시판</a>
				<ul class="sub-menu">
...
<body>
<form action="<%=request.getContextPath() %>/HW/exerboard/insert.do" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<td>글 제목 : </td>
				<td><input type="text" name="exerBoardTitle" value=""></td>
			</tr>
			<tr>
				<td>글 내용: </td>
				<td><input type="text" name="exerBoardContent" value=""></td>
			</tr>
				<td>첨부파일</td>

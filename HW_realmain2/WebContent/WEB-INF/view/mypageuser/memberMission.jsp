...
<body>
<form action="<%=request.getContextPath() %>/HW/mypageuser/Mission.do" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<td>회원 아이디 : </td>
			...
			<tr>
				<td>미션1 : </td>
				<td><textarea rows="20" cols="20" name="mission1" ></textarea></td>
			</tr>
			<tr>
				<td>미션2 : </td>
				<td><textarea rows="20" cols="20" name="mission2" ></textarea></td>
			</tr>
			<tr>
				<td>미션3 : </td>
				<td><textarea rows="20" cols="20" name="mission3" ></textarea></td>
			</tr>
			<tr>
				<td>날짜: </td>

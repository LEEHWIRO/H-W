...
<!--       	</ul> -->
       <ul class="navbar-nav ml-auto">
        ...
        <ul class="navbar-nav ml-5">
          <li class="nav-item"> 
<%--           	<a class="nav-link btn btn-danger" href="<%=request.getContextPath() %>/HW/main/main.do">&nbsp;LogIn&nbsp;</a>  --%>
				 <% 
							...
							<table>
								<tbody>
									<%
										...
										int allProdPrice = 0;
										String gradeCode =  (String) session.getAttribute("signedUser");
										if(noticeSize > 0){
										if (gradeCode == null) {
											for (int i = 0; i < noticeSize; i++) {
									%>
									<tr class="row100 body">
										<td class="cell100 column3"><%=noticeList.get(i).getNoticeWriter()%></td>
										<td class="cell100 column1"><a
											href="<%=request.getContextPath()%>/HW/main/login.do"> <%=noticeList.get(i).getNoticeTitle()%>
										</a> </td>
										<td class="cell100 column4"><%=noticeList.get(i).getNoticeDate()%></td>
										<td class="cell100 column5"><%=noticeList.get(i).getNoticeCount()%></td>
									</tr>
									<%
										}
										} else {
									...
									<tr class="row100 body">
										<td class="cell100 column3"><%=noticeList.get(i).getNoticeWriter()%></td>
										<td class="cell100 column1"> <a
											href="<%=request.getContextPath()%>/HW/notice/select.do?boardNum=<%=noticeList.get(i).getNoticeNum()%>">
